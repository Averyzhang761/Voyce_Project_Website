# Generated by Django 3.0.3 on 2020-06-10 03:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Open_Female_Medicaid_Beds', models.IntegerField(blank=True, max_length=11)),
                ('Open_Male_Medicaid_Beds', models.IntegerField(blank=True, max_length=11)),
                ('Open_Female_Medicare_Beds', models.IntegerField(blank=True, max_length=11)),
                ('Open_Male_Medicare_Beds', models.IntegerField(blank=True, max_length=11)),
                ('Open_Female_Private_Pay_Beds', models.IntegerField(blank=True, max_length=11)),
                ('Open_Male_Private_Pay_Beds', models.IntegerField(blank=True, max_length=11)),
                ('Open_Female_Dementia_Beds', models.IntegerField(blank=True, max_length=11)),
                ('Open_Male_Dementia_Beds', models.IntegerField(blank=True, max_length=11)),
                ('Notes', models.CharField(blank=True, max_length=200)),
            ],
            options={
